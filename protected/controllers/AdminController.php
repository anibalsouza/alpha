...
class AdminController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow Superadmin user to perform 'create' and 'update' actions
				'actions'=>array('create','update','admin','delete'),
				'expression'=>'($user->type == "SuperAdmin")',
				'users'=>array('@'),
			),
...
//			$model->status_pagamento="";
	...
	public function loadModel($id)
	{
		...
		$equipe = Yii::app()->user->equipe; // Só ve o admin da propria 
