...
class MessageController extends Controller
{
	...
	public function actionNew()
	{
		...
		if(isset($_POST['Mailbox']['to']))
		{
			...
			echo Usuario::model()->findbypk($conv->interlocutor_id)->equipe_id;
			echo Yii::app()->user->equipe;
			
			if(Usuario::model()->findbypk($conv->interlocutor_id)->equipe_id == Yii::app()->user->equipe){
				$conv->addError('to', "User not found?");
			}
